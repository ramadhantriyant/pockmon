...
type Querier interface {
	...
	ListAllBudgetsExceedingThreshold(ctx context.Context, arg ListAllBudgetsExceedingThresholdParams) ([]ListAllBudgetsExceedingThresholdRow, error)
	...
	ListGoalsReachedTarget(ctx context.Context) ([]ListGoalsReachedTargetRow, error)
